...
$(document).ready(function(){
    ...
    if (queryParam) {
        ...
        $.getJSON(`//data.hungbok.net/data/games/${queryParam}.json`, function (data) {
            ...
            '</div>');
            $(".external-store-link.battlenetkr").append('<div class="external-link" region_301" ttt="Battle.net">'+
            ...
            '</div>');
            $(".external-store-link.psstorekrhktw").append('<div class="external-link region_703" ttt="PlayStation Store">'+
            ...
            '</div>');
            $(".external-store-link.psstorekr").append('<div class="external-link region_301" ttt="PlayStation Store">'+
            ...
            '</div>');
            // multiple
            $(".external-store-link.eshopkrhktw").append('<div class="external-link region_703" ttt="Nintendo eShop">'+
                '<a class="external-link-button icon-nintendoeshop" href="' + nintendoeshopkrhktwurl + '" target="_blank"></a>'+
            '</div>');
            // kr
            $(".external-store-link.eshopkr").append('<div class="external-link region_301" ttt="Nintendo eShop">'+
