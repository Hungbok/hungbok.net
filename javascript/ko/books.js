...
$(document).ready(function(){
    ...
    if (queryParam) {
        // JSON 파일 가져오기
        $.getJSON(`//data.hungbok.net/data/books/${queryParam}.json`, function (data) {
            ...
            videoData.forEach(function(item) {
                $(".slider").append('<div class="slider-item">'+
                    '<div class="video-play-button ' + item.server + '-link" videoid="' + item.id + '">'+
                        '<img class="slider-background" src="//media.hungbok.net/image/books/' + url + '/hb_video_' + item.id + '.' + item.extension + '" onerror="this.src=`//media.hungbok.net/image/hb/hb_error_horizontal.svg`;">'+
                        '<img class="slider-background" src="//media.hungbok.net/image/books/' + url + '/hb_video_' + item.id + '.' + item.extension + '" onerror="this.src=`//media.hungbok.net/image/hb/hb_error_horizontal.svg`;">'+
            ...
            imageData.forEach(function(item) {
                $(".slider").append('<div class="slider-item">'+
                    '<a class="slider-image" href="//media.hungbok.net/image/books/' + url + '/hb_' + item.img + '.jpg" data-lightbox="preview">'+
                        '<img class="slider-background" src="//media.hungbok.net/image/books/' + url + '/hb_' + item.img + '.jpg" onerror="this.src=`//media.hungbok.net/image/hb/hb_error_horizontal.svg`;">'+
                        '<img class="slider-background" src="//media.hungbok.net/image/books/' + url + '/hb_' + item.img + '.jpg" onerror="this.src=`//media.hungbok.net/image/hb/hb_error_horizontal.svg`;">'+
                    '</a>'+
                '</div>');
            });
            ...
            storyData.forEach(function(item, index) {
                var storyCard = $('<div class="story-card">'+
                    ...
                    '<div class="story-image">'+
                        ...
                        '<img class="story-background" src="//media.hungbok.net/image/books/' + url + '/hb_' + item.img + '.jpg" onerror="this.remove ? this.remove() : this.removeNode();" loading="lazy">'+
                    '</div>'+
            ...
            settingData.forEach(function(item, index) {
                var settingCard = $('<div class="setting-card">'+
                    '<div class="setting-image">'+
                        ...
                        '<img class="setting-background" src="//media.hungbok.net/image/books/' + url + '/hb_' + item.img + '.jpg" onerror="this.remove ? this.remove() : this.removeNode();" loading="lazy">'+
                    '</div>'+
            ...
            characterData.forEach(function(item, index) {
                var characterCard = $('<div class="character-card">'+
                    '<div class="character-image">'+
                        '<img class="character-background" src="//media.hungbok.net/image/books/' + url + '/hb_' + item.img + '.jpg"  onerror="this.src=`//media.hungbok.net/image/hb/hb_error.svg`;this.className=`onerror`;" loading="lazy">'+
                    '</div>'+
                ...
                $(".music").append('<div class="music-card">'+
                    ...
                    '<div class="music-video">'+
                        '<div class="video-play-button ' + item.server + '-link" videoid="' + item.videoid + '">'+
                            ...
                            '<img class="slider-background" src="//media.hungbok.net/image/books/' + url + '/hb_video_' + item.videoid + '.' + item.extension + '" onerror="this.remove ? this.remove() : this.removeNode();" loading="lazy">'+
                        '</div>'+
                    '</div>'+
            ...
            episodeData.forEach(function(item) {
                $(".books-tables tbody").append('<tr i="' + item.line + '" class="books-tr">' + item.text + '</tr>');
            });
...
function showError(image) {
    ...
    // JSON 파일 불러오기
    fetch(`//data.hungbok.net/data/books/${q}.json`)
        .then(response => {
            if (!response.ok) {
