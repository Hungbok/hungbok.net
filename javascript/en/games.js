        ...
        $.getJSON(`//data.hungbok.net/data/games/${queryParam}.json`, function (data) {
            ...
            function formatDate(date) {
                ...
                switch (parts.length) {
                    case 6: // yyyy-mm-dd-hh-mm-ss
                        formattedDate = `${monthName} ${parts[2]}, ${parts[0]}`;
                        break;
            ...
            metacriticData.forEach(function(item) {
                $(".rating-card.metacritic.rating-three-score").append('<div class="rating-card rating-two-score ' + item.platform + '">'+
                    ...
                    '</div>'+
                    '<div class="rating-score">'+
                        '<div class="rating-title">User Score</div>'+
            ...
            $(".rating.opencritic").append('<div class="rating-card opencritic rating-three-score">'+
                ...
                '</div>'+
                '<div class="rating-score">'+
                    '<div class="rating-title">OpenCritic Rating</div>'+
                ...
                '</div>'+
                '<div class="rating-score">'+
                    '<div class="rating-title">Top Critic Average</div>'+
                ...
                '</div>'+
                '<div class="rating-score">'+
                    '<div class="rating-title">Critics Recommend</div>'+
            ...
            $(".rating.steam").append('<div class="rating-card steam rating-two-score">'+
                ...
                '</div>'+
                '<div class="rating-score">'+
                    '<div class="rating-title">ALL REVIEWS</div>'+
                ...
                '</div>'+
                '<div class="rating-score">'+
                    '<div class="rating-title">RECENT REVIEWS</div>'+
        ...
        async function loadGameData() {
            try {
                ...
                topGames.forEach(game => {
                    // en 값이 있으면 그 값을, 없으면 en 값을 사용
                    const title = game.en ? game.en.title : game.en.title;
                    const summary = game.en ? game.en.summary : game.en.summary;
