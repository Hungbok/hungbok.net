    ...
    $("body").prepend('<header class="nav-down">' +
        '<nav class="nav-header">' +
            ...
            '<div class="search-container">' +
                '<input type="text" id="value" placeholder="" autocomplete="off">'+
                ...
                '<div class="language-lists">' +
                    '<div class="language-list">' +
                        ...
                        '<div class="language-select" data-lang="cs">' +
                            ...
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="cs-cz">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/cz.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="de">' +
                            ...
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="de-de">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/de.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="fi">' +
                            ...
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="fi-fi">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/fi.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="hu">' +
                            ...
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="hu-hu">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/hu.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="hi">' +
                            ...
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="hi-in">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/in.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="it">' +
                            ...
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="it-it">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/it.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="nl">' +
                            ...
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="nl-nl">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/nl.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="pl">' +
                            ...
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="pl-pl">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/pl.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="ru">' +
                            ...
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="ru-ru">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/ru.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="ar">' +
                            ...
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="ar-sa">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/sa.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="th">' +
                            ...
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="th-th">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/th.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="tr">' +
                            ...
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="tr-tr">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/tr.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="uk">' +
                            ...
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="uk-ua">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/ua.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="ja">' +
                            ...
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="ja-jp">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/jp.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="ko">' +
                            ...
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="ko-kr">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/kr.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="zh-cn">' +
                            ...
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="zh-hans">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/cn.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="zh-tw">' +
                            ...
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="zh-hant">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/tw.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="bg">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/bg.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="bg-bg">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/bg.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="ms">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/id.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="ms-id">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/id.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="el">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/gr.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="el-gr">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/gr.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="no">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/no.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="no-no">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/no.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="da">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/dk.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="da-dk">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/dk.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="sv">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/se.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="sv-se">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/se.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="ro">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/ro.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="ro-ro">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/ro.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        ...
                        '<div class="language-select" data-lang="vi">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/vn.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
                        '</div>' +
                        '<div class="language-select" data-lang="vi-vn">' +
                            '<div class="language-flag">' +
                                '<img src="https://www.hungbok.net/img/flag/vn.svg">' +
                            '</div>' +
                            '<div class="language-text"></div>' +
